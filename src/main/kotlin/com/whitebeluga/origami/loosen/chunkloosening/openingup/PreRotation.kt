...
internal class PreRotation(val line: Line, val rotationDirection: Vector,
                  val openedUpFacesThatShouldBeAbove: Set<Face>, val openedUpFacesThatShouldBeBelow: Set<Face>)